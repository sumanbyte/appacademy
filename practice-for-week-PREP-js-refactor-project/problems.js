...
// console.log(countVowels('no spaces'))
...
console.log(countConsonants('no spaces'))
...
function alternatingLetters(str){
    ...
    for(let i=0; i<strCharArr.length; i++){
        if(i%2 !== 0){
            strCharArr[i] = strCharArr[i].toUpperCase()
        }else{
            strCharArr[i] = strCharArr[i].toLowerCase()
        }
    }
    return strCharArr.join('')
}

// console.log(alternatingLetters('helloworld'))
