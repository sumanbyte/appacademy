const hex2bin = require('./1-convertToBase10')
...
function decToBin(num) {
  ...
  while(num >= 1){
    let remainder = num % 2
    num /= 2
    ans.unshift(Math.floor(remainder))
  }
...
const convertToBase2 = (element) => {
  ...
  if(typeof element === 'string'){
    if(element.startsWith("0x")){
      return "0b" + hex2bin(element)
    }
  }else if(typeof element === 'number'){
    return "0b" + decToBin(element)
  }else{
...
// console.log(convertToBase2([])); // 0b1011111100010010
